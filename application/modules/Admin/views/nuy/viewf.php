...
<div id="Breadcrumb" class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom">
    <ul>
        ...
        <li class="SecondLast"><a href="Admin/viewf/editcode">Chỉnh sửa code </a></li>
    </ul>
</div>
                     ...
                     <tbody>
                        <tr>
                          <?php if($table['help']==1){ ?>
                           ...
                           <?php if($table['edit']==1) { ?>
                           <td align="center">
                              <a id="" title="Lưu" class=" updatefile toolbar btn btn-info" href="<?php echo base_url().'Admin/'.'updateFileCode'?>"><i class="icon-plus"></i>&nbsp;
                              Lưu lại</a>
                           </td>
                           <?php } ?>
                        </tr>
