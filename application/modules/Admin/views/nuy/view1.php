  ...
  $(document).ready(function() {
    ...
    function deleteAll(){
       ...
       if(datawhere.length>0){
          bootbox.confirm("Bạn có thực sự muốn xóa các <?php echo $table['name'] ?> này không?", function(ret){
            if(!ret)return;
            checkReload=false;
    ...
    function deleteItem(_this){
      bootbox.confirm("Bạn có muốn xóa <?php echo $table['name'] ?> này không?",function(ret){
                  ...
                  <table class="toolbar">
                     <tbody>
                        <tr>
                          <td align="center">
                            <?php if($table['quickpost']==1){ ?>
                              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#dragzone"><i class="icon-upload-alt"></i> Đăng nhanh</button>
                              <?php } ?>
                           </td>
                          <?php if($table['help']==1){ ?>
                           <td align="center">
