...
<div id="Breadcrumb" class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom">
    <ul>
        ...
        <li class="SecondLast"><a href="Admin/viewSitemap">Quản lý media</a></li>
    </ul>
</div>
<div id="cph_Main_ContentPane">
   <div class="widget row margin0">
      <div class="widget-title aclr">
         ...
         <h4>
            <i class="icon-qrcode"></i>&nbsp; Quản lý media
         </h4>
      ...
      <i alt="Full màn hình" onclick="toggleFullScreen();" class="fullscreen icon-fullscreen fullcren"></i>
        <iframe id="full" style="width:92vw;min-height:100vh;border: none;" src="<?php echo base_url() ?>Admin/mediaManager"></iframe>
