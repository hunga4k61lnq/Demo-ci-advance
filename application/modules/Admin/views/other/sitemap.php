...
<div id="Breadcrumb" class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom">
    <ul>
        ...
        <li class="SecondLast"><a href="Admin/viewSitemap">Thông tin Sitemap</a></li>
    </ul>
</div>
<div id="cph_Main_ContentPane">
   <div class="widget row margin0">
      <div class="widget-title">
         ...
         <h4>
            <i class="icon-qrcode"></i>&nbsp; Thông tin Sitemap
         </h4>
     ...
     function createSitemap(){
      checkReload=true;
      $.ajax({
        url: 'Admin/createSitemap',
        type: 'POST',
        data: {param1: 'value1'},
      })
      .done(function(e) {
        window.location.href = '<?php echo base_url() ?>Admin/viewSitemap';
      })
      .fail(function() {
        console.log("error");
      })
