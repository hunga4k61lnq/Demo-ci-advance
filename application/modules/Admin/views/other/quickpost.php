...
function getAllImageQuickPost(){
  ...
  $.ajax({
    url: "Admin/doQuickPost/<?php echo $table[0]['name'] ?>",
    type: 'POST',
...
{
  var uploadURL ="Admin/quickpost/<?php echo $table[0]['name'] ?>"; //Upload URL
...
"><i style="display: block;
  ...
  <input type="hidden" name="enuy_controller" value="<?php echo $table[0]['controller'] ?>"/>
