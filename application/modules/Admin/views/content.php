                           ...
                           <div class="widget">
                              ...
                              <div class="widget-body">
                                 <ul class="hotIconList thongbao">
                                    <?php 
                                    if(@$enuy && property_exists($enuy, 'hot')){
                                       foreach ($enuy->hot as $key => $value) {
                                          echo '<li class="thongbaohot"><i class="icon-fire"></i>';
                                          echo '<a target="_blank" href="http://enuy.com.vn/'.$value->slug.'">'.$value->name.'</a>';
                                          echo '</li>';
                                       }
                                    }
                                     ?>
                                 ...
                                 <div class="supportInfoNew support-info homecontainer row margin0">
                                    ...
                                    <div class="info infoMarginLeft" style="color:#606060;">
                                       ...
                                       <div class="f14" style="margin-bottom:-5px;">
                                          Trung tâm trợ giúp Enuy sẽ hỗ trợ bạn sớm nhất &nbsp;
                                       </div>
                                    </div>
                                    <div class="clear">
                                    </div>
                                          ...
                                          for ($i=0; $i < $count; $i++) { 
                                             ...
                                             <div class="col-sm-2 col-xs-12 responsive" data-desktop="span2" data-tablet="span3">
                                                <div class="circle-wrap">
                                                   <a href="Admin/view/<?php echo $arr[$i]['name'] ?>">
                                       ...
                                       <?php $count = count($arr);
                                          for ($i=0; $i < $count; $i++) { 
                                             ...
                                             <div class="col-sm-3 col-xs-6">
                                                <a href="Admin/view/<?php echo $arr[$i]['name'] ?>" class="icon-btn ">
                                                   <i class="icon-<?php echo $icon[$i%count($color)] ?>"></i>
                                                   <div>
                                                      <?php echo $arr[$i]['note'] ?>
                                                   </div>
                                              ...
                                              <?php if($arr[$i]['insert']==1 && $this->Admindao-> checkPermissionAction($arr[$i]['name'],'insert')){
                                                ?>
                                                <div class="col-sm-3 col-xs-6">
                                                   <a href="Admin/insert/<?php echo $arr[$i]['name'] ?>" class="icon-btn">
                              ...
                              <div class="widget-body maxheight">
                                 <div id="contentTab_1" style="display: block;">
                                    <div id="rssfeedsSupport" class="rssFeedDisplay" style="overflow-y:scroll">
                                       <?php 
                                          if(@$enuy && property_exists($enuy, 'hoto')){
                                             foreach ($enuy->hoto as $key => $value) {
                                                echo '<div class="item">';
                                                echo '<a class="titlefield" target="_new" href="http://enuy.com.vn/'.$value->slug.'" rel="nofollow">'.$value->name.'</a><span class="datefield"></span>';
                                                echo '</div>';
                                             }
                                          }
                                       ?>
                                 ...
                                 <div id="contentTab_2" style="display: none;">
                                    ...
                                    <div id="rssfeedsVideo" class="rssFeedDisplay" style="overflow-y:scroll">
                                       <?php 
                                          if(@$enuy && property_exists($enuy, 'hotc')){
                                             foreach ($enuy->hotc as $key => $value) {
                                                echo '<div class="item">';
                                                echo '<a class="titlefield" target="_new" href="http://enuy.com.vn/'.$value->slug.'" rel="nofollow">'.$value->name.'</a><span class="datefield"></span>';
                                                echo '</div>';
                                             }
                                 ...
                                 <div id="contentTab_3" style="display: none;">
                                    <div id="rssfeedsBlog" class="rssFeedDisplay" style="overflow-y:scroll">
                                        <?php 
                                          if(@$enuy && property_exists($enuy, 'hotf')){
                                             foreach ($enuy->hotf as $key => $value) {
                                                echo '<div class="item">';
                                                echo '<a class="titlefield" target="_new" href="http://enuy.com.vn/'.$value->slug.'" rel="nofollow">'.$value->name.'</a><span class="datefield"></span>';
                                                echo '</div>';
                                             }
