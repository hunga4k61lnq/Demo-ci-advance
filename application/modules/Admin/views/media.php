        ...
        <div class="content">
          <div class="breadcrumb aclr">
            <div class="detail-breadcrumb fl">
              <ul class="aclr fl">
                <li class="fl"><a href="Admin/mediaManager"><i class="icon-home"></i></a>/</li>
                <?php 
                ...
                if(!isNull($path_uploads)){
                  ...
                  $pathBreadcrumb = base_url()."Admin/mediaManager";
            ...
            <div class="moretools fr">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  <li><a href="Admin/setOrderingFile/filedown">Tên file<i class="fa fa-long-arrow-down"></i></a></li>
                  <li><a href="Admin/setOrderingFile/fileup">Tên file<i class="fa fa-long-arrow-up"></i></a></li>
                  <li><a href="Admin/setOrderingFile/datedown">Ngày tạo<i class="fa fa-long-arrow-down"></i></a></li>
                  <li><a href="Admin/setOrderingFile/dateup">Ngày tạo<i class="fa fa-long-arrow-up"></i></a></li>
                  <li><a href="Admin/setOrderingFile/sizedown">Dung lượng<i class="fa fa-long-arrow-down"></i></a></li>
                  <li><a href="Admin/setOrderingFile/sizeup">Dung lượng<i class="fa fa-long-arrow-up"></i></a></li>
                </ul>
              </div>
              <a class="refreshnow" href="Admin/mediaManager">
        ...
        <div class="modal-dialog modal-lg" style="margin-top: 7%;">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="Admin/uploadMultiFile" id="uploadmultifile" method="post" enctype="multipart/form-data" style="    text-align: center;">
